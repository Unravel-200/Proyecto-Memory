...
La matriz contiene 30 PASS y 54 IDs `NOT RUN`.
...
- No se ejecutaron todavía look, velocidad recta, sprint, crouch, salto, cambio
  ...
  rendimiento. La matriz tiene 30 PASS y 54 IDs que continúan `NOT RUN`.
