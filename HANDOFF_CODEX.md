...
La matriz contiene 35 PASS, 1 BLOCKED y 48 IDs `NOT RUN`.
...
- No se ejecutaron todavía look, velocidad recta, sprint, crouch, salto, cambio
  ...
  rendimiento. La matriz tiene 35 PASS, 1 BLOCKED y 48 IDs que continúan `NOT RUN`.
