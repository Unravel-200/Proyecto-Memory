...
La matriz contiene 35 PASS y 49 IDs `NOT RUN`.
...
- No se ejecutaron todavía look, velocidad recta, sprint, crouch, salto, cambio
  ...
  rendimiento. La matriz tiene 35 PASS y 49 IDs que continúan `NOT RUN`.
