...
if primary is None:
    primary = starts[0] if starts else unreal.EditorLevelLibrary.spawn_actor_from_class(unreal.PlayerStart, unreal.Vector(-28000,-30000,3000), unreal.Rotator(0,90,0))
primary.set_actor_label('PlayerStart_Campus_Natural')
primary.set_actor_location(unreal.Vector(-28000,-30000,3000), False, False)
